...
public class LastModifyDate {
    ...
    @Expose
    private DayDate_ dayDate;
    @SerializedName("dayTime")
    @Expose
    private DayTime_ dayTime;
    @SerializedName("time")
    @Expose
    private Long time;
    @SerializedName("null")
    ...
    public DayDate_ getDayDate() {
        return dayDate;
    }

    public void setDayDate(DayDate_ dayDate) {
        this.dayDate = dayDate;
    }

    public DayTime_ getDayTime() {
        return dayTime;
    }

    public void setDayTime(DayTime_ dayTime) {
    ...
    public boolean equals(Object o) {
        ...
        LastModifyDate that = (LastModifyDate) o;
